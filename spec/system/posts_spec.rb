    ...
    describe '投稿ワードの一覧' do
      ...
      context 'ログインしている場合' do
        it 'Topページのリンクから遷移できる' do
          ...
          expect(current_path).to eq('/posts'), 'Topページのリンクからポジティブワードを共有するに遷移できません'
        end
    ...
    describe '投稿の作成' do
      ...
      context 'ログインしている場合' do
        ...
        it '正しいタイトルが表示されていること' do
          ...
          expect(current_path).to eq('/posts/new'), '新規投稿作成ページに遷移できません'
    ...
    describe '投稿の削除' do
      ...
      context '自分の投稿' do
        it '投稿が削除できること' do
          ...
          expect(current_path).to eq('/posts'), 'フラッシュメッセージ「編集できません」が表示されていません'
        end
      end
